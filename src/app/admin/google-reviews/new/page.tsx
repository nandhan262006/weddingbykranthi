  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-white/30 text-sm mt-1">Add a new customer review</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input value={form.date} onChange={(e) => setForm({ ...form, date: e.target.value })}
              className="w-full bg-white/[0.03] border border-white/[0.08] text-white px-4 py-2.5 rounded-xl text-sm focus:border-[#D4AF37]/50 focus:outline-none focus:ring-1 focus:ring-[#D4AF37]/20 transition-colors" placeholder="e.g. December 2025" />
          </div>
          <div>
